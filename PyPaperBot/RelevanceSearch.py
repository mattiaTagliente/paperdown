...
def find_relevant_papers(topic, start_year, end_year, base_dwn_dir, num_reviews=3, num_non_reviews=6, s2_api_key=None):
    print("--- Starting Relevance Search ---")
    # ... (Phase 1 & 2 are the same as the previous version) ...
    ...
    final_paper_list = getPapersInfo(final_paper_list, "RelevanceSearch", None, len(final_paper_list))
    ...
    downloadPapers(final_paper_list, results_dir, num_limit=len(final_paper_list))